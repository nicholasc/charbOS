...
_ yay -Sy --noconfirm --needed ttf-font-awesome noto-fonts noto-fonts-emoji noto-fonts-cjk noto-fonts-extra
...
if ! fc-list | grep -qi "CaskaydiaMono Nerd Font"; then
  ...
  cd /tmp
  _ wget https://github.com/ryanoasis/nerd-fonts/releases/latest/download/CascadiaMono.zip
...
if ! fc-list | grep -qi "iA Writer Mono S"; then
  ...
  cd /tmp
  _ wget -O iafonts.zip https://github.com/iaolo/iA-Fonts/archive/refs/heads/master.zip
